;############################################
;# A template script for the M.S.S. project #
;# and for making unused pins safe          #
;# Written by: Alexander Kinko              #
;#			   Roni Lavi                    #
;############################################
puts \n
if {[is_project_open]} {
...
#  set_location_assignment  PIN_N2  -to CLK
   set_location_assignment  PIN_N2  -to CLK_IN 							;# 	Global clock of the project
...
#   set_location_assignment PIN_AE22  -to LEDG[0] ;# LEDG0				;# Used for indication of reset keypress
#   set_location_assignment PIN_AF22  -to LEDG[1] ;# LEDG1				;#	Reserved
#   set_location_assignment PIN_W19   -to LEDG[2] ;# LEDG2				;#	Reserved
...
#   set_location_assignment PIN_Y18   -to LEDG[7] ;# LEDG7				;#	Reserved
#   set_location_assignment PIN_Y12   -to LEDG[8] ;# LEDG8				;#	Reserved
...
#   set_location_assignment PIN_AE23  -to LEDR[0]   ;# LEDR0				;#	Used for indication of slide switch #0
#   set_location_assignment PIN_AF23  -to LEDR[1]   ;# LEDR1				;#	Used for indication of slide switch #1
#   set_location_assignment PIN_AB21  -to LEDR[2]   ;# LEDR2				;#	Used for indication of slide switch #2
#   set_location_assignment PIN_AC22  -to LEDR[3]   ;# LEDR3				;#	Used for indication of slide switch #3
#   set_location_assignment PIN_AD22  -to LEDR[4]   ;# LEDR4				;#	Used for indication of slide switch #4
#   set_location_assignment PIN_AD23  -to LEDR[5]   ;# LEDR5				;#	Used for indication of slide switch #5
#   set_location_assignment PIN_AD21  -to LEDR[6]   ;# LEDR6				;#	Used for indication of slide switch #6
#   set_location_assignment PIN_AC21  -to LEDR[7]   ;# LEDR7				;#	Used for indication of slide switch #7
#   set_location_assignment PIN_AA14  -to LEDR[8]   ;# LEDR8				;#	Used for indication of slide switch #8
#   set_location_assignment PIN_Y13   -to LEDR[9]   ;# LEDR9				;#	Used for indication of slide switch #9
#   set_location_assignment PIN_AA13  -to LEDR[10]  ;# LEDR10			;#	Used for indication of slide switch #10
#   set_location_assignment PIN_AC14  -to LEDR[11]  ;# LEDR11			;#	Used for indication of slide switch #11
...
#   set_location_assignment PIN_AE13  -to LEDR[15]  ;# LEDR15			;#	Used for indication of slide switch #15
#   set_location_assignment PIN_AE12  -to LEDR[16]  ;# LEDR16			;#	Used for indication of slide switch #16
#   set_location_assignment PIN_AD12  -to LEDR[17]  ;# LEDR17			;#	Used for indication of slide switch #17
