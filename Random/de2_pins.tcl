...
#   set_location_assignment PIN_V2   -to SW17  ;# SW17 on the left side
   ...
   set_location_assignment PIN_AE22  -to RANDOM[0] ;# LEDG0 on the right side
   set_location_assignment PIN_AF22  -to RANDOM[1] ;# LEDG1
   set_location_assignment PIN_W19   -to RANDOM[2] ;# LEDG2
   set_location_assignment PIN_V18   -to RANDOM[3] ;# LEDG3
   set_location_assignment PIN_U18   -to RANDOM[4] ;# LEDG4
   set_location_assignment PIN_U17   -to RANDOM[5] ;# LEDG5
   set_location_assignment PIN_AA20  -to RANDOM[6] ;# LEDG6
   set_location_assignment PIN_Y18   -to RANDOM[7] ;# LEDG7
   set_location_assignment PIN_Y12   -to pulse     ;# LEDG8 Between 7-Segments
...
#   set_location_assignment PIN_AE12  -to LEDR16  ;# LEDR16
   set_location_assignment PIN_AD12  -to rise  ;# LEDR17 on the left side
